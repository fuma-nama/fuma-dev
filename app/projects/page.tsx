    ...
    return (
        <main className="container py-10 md:py-28">
            ...
            <p className="text-sm text-muted-foreground">
                Frameworks, Libraries, Web apps, I build things with
                high-quality.
            </p>
            <div className="flex flex-col gap-4 mt-8">
                <Card href="https://shark-chat.vercel.app" title="Shark Chat">
                    A modern chat app written in Typescript and built with
                    Next.js.
                </Card>
                <Card
                ...
                <Card
                    ...
                    title="Discord FP"
                >
                    A Beautiful Application Command Library for Discord.js and
                    Discordeno.
                </Card>
            </div>
            ...
            <h2 className="text-lg sm:text-xl font-bold mt-12 mb-2">
                Experimental
            </h2>
            <p className="text-sm text-muted-foreground">
                Unstable projects built for fun or experiment, with bleeding
                edge technologies.
            </p>
            <div className="flex flex-col gap-4 mt-8">
                <Card
                ...
                >
                    A discord bot template with dashboard & documentation using
                    Next.js App Router.
                </Card>
            </div>
            ...
            <div className="flex flex-col gap-4 mt-8">
                ...
                <Card
                    ...
                    title="Omagize"
                >
                    The Chat App with a lot of features, written in Java and
                    Typescript.
                </Card>
            </div>
        </main>
